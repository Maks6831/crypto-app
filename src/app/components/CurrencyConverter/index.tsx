...
export const Currencyconverter = () => {
  ...
  return (
    <div
      ...
      className="relative h-12 w-[4.8rem] p-1 cursor-pointer bg-opacity-40 flex flex-column items-center justify-between m-1 md:p-2 bg-light-button-color rounded-xl dark:bg-dark-button-color dark:bg-opacity-100"
    >
