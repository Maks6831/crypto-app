    ...
    <div className=" shadow-lg bg-coin-card-color bg-opacity-30 dark:bg-purplea rounded-xl max-h-5/6 w-full">
                      <div className="flex flex-col min-[430px]:flex-row justify-between w-full h-1/3  items-center p-3 min-[430px]:p-5">
                        <div className="flex justify-center items-center">
                          <div className=' rounded-full bg-carousel-button-color-one bg-opacity-20 border-carousel-button-color-two border-opacity-25 shadow-sm shadow-carousel-button-color-two dark:shadow-purpla'>
                      ...
                      <div className="flex flex-col min-[430px]:flex-row justify-between w-full h-1/3 items-center p-3 min-[430px]:p-5 ">
                        <div className="flex justify-center items-center">
                          <div className=' rounded-full bg-carousel-button-color-one bg-opacity-20  border-opacity-25 shadow-sm shadow-carousel-button-color-two dark:shadow-coin-page-progress'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                              <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                            </svg>
                          </div>
