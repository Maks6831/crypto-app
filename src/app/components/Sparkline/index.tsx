...
export const Sparkline = ({
    ...
    datasets: [
      {
        ...
        backgroundColor: (context: any) => {
          ...
          theme === "light"
            ...
            : gradient.addColorStop(0.7, "rgba(30, 25, 50,1)");
          gradient.addColorStop(
            0.1,
            `rgba(${getColor(number, "graph", theme, change7d)}, 0.6)`
          ); // End with borderColor
  ...
  return (
    <td className="  bg-white dark:bg-dark-card  flex justify-center items-center  pr-3 rounded-r-3xl w-28 sm:w-36  h-20 ">
