    ...
    <div className=' w-11/12 h-full shadow-lg  bg-carousel-button-color-two bg-opacity-40 dark:bg-purplea rounded-xl flex flex-col p-2'>
        <div className=' h-3/5 md:p-2  w-full '>
            ...
            <div className=' h-1/2 w-full border-b border-opacity-25 border-card-text-gray flex flex-col justify-center p-2 md:p-0  '>
                <div className='flex justify-start items-center  md:p-1'>
                    ...
                    <div className='font-medium xl:text-xl lg:text-lg md:text-base sm:text-sm text-xs p-1'>{percentage}%</div>
                </div>
                <div className='flex justify-start items-center'>
                    
                    <div className='xl:text-xl lg:text-lg md:text-base sm:text-sm text-xs p-1 text-light-text-color dark:text-card-text-gray'>{isPortfolio ? 'profit': "High 24h:" }</div>
        ...
        <div className=' h-2/5 p-2'>
            ...
            <div className='flex justify-between w-full '>
                    ...
                    <div className=' text-purpleb dark:text-white xl:text-2xl lg:text-xl md:text-lg sm:text-base text-sm'>{symbol}{atlPrice}</div>
                </div>
                <div className='text-light-text-color dark:text-card-text-gray xl:text-base lg:text-lg md:text-md sm:text-sm text-xs'>{`${atlDate}`}</div>
            </div>  
        </div>
    </div>
  )
