        ...
        <div className=" h-1/2 w-full border-b border-opacity-25 border-card-text-gray flex flex-col justify-center p-2 md:p-0  ">
          ...
          <div className="flex justify-start items-center">
            <div
              ...
              className="xl:text-xl lg:text-lg md:text-base sm:text-sm text-xs p-1 text-light-text-color dark:text-card-text-gray"
            >
              {isPortfolio ? "profit" : "High 24h:"}
            </div>
            <div className="xl:text-xl lg:text-lg md:text-base sm:text-sm text-xs p-1">
              {symbol}
