...
export const TableElement = ({number, name, image, symbol, price, change1h, change24h, change7d, sparkline, volume24h, marketCap, circulating, totalSupply} 
  ...
  return (
    <tr  className=' h-20 mb-3  gap-4 cursor-pointer  w-full  first:rounded-l-xl '>
        <td className=' bg-white dark:bg-dark-card  p-5 rounded-l-xl hidden xl:table-cell '><span className='flex flex-row items-center justify-center'>{number}</span></td>
