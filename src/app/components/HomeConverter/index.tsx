  ...
  return (
    <div className='m-3 w-full flex justify-center items-center flex-col  h-full relative '>
      ...
      <div className='flex w-full h-full justify-center relative '>
        <div onClick={switchPair} className='w-12 inset-0 mx-auto my-auto  h-12 absolute rounded-3xl  bg-purpleb dark:bg-white flex justify-center items-center cursor-pointer'>
