...
export const CoinInfoContainer = ({ isPrice } : { isPrice : boolean}) => {
  ...
  return (
    <div className='absolute left-6 top-6'>
        ...
        <div className='font-bold text-3xl mb-2 leading-7 text-light-text-color-three dark:text-white'>{symbol}{isPrice ?moneyConverter(+prices[prices.length-1], 3)  :moneyConverter(market_caps[market_caps.length-1],3)}</div>
